...
# Input:
# siglist: siglist of LigScape
# sigmeta: sigmeta of LigScape
# Output:
# A list siggroups, with siggroups$sigLs = the vector of ligands in LigScape, siggroups$siggroups = the list of signatureid-vectors of each ligand
################################################################################

#' Group the signatures by treatment ligands
#'
#' @param siglist siglist of LigScape
#' @param sigmeta sigmeta of LigScape
#'
#' @return
#' a list siggroups:
#' siggroups$sigLs: the vector of ligands in LigScape
