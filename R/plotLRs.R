################################################################################
# Plot the average expression of ligands in sender cells, receptors in specified receiver cells, or the ligand scores calculated by LigScape signatures for identified LR interactions.
# Input:
...
# or the corresponding ligand scores calculated by LigScape signatures, for identified LR interactions.
################################################################################
