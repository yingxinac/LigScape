...
# whichLs: specifies the set of ligand genes to examine. "in.lrnetwork" (all ligand genes in lr_network) or "in.LigScape.only" (ligand genes in lr_network that are included in LigScape).
...
#' @param whichLs specifies the set of ligand genes to examine. "in.lrnetwork" (all ligand genes in lr_network) or "in.LigScape.only" (ligand genes in lr_network that are included in LigScape).
...
plotDELRheatmap <- function(exprinfo, siggroups, lr_network, whichLs = "in.LigScape.only", cls, condpair, LorR = "L",
