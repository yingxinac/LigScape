---
title: "Perform LigScape analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{LigScape}
...
```
### Load LigScape data
LigScape data can be downloaded at [LigScapeData](https://github.com/yingxinac/LigScapeData/)
``` r
...
```
**Plot expression of differentially expressed ligand- and receptor-genes in each cell-type/cluster, each condition, in heatmap**
``` r
...
<div align="center">
<img src="DELs.tiff" width="300" height = "800"/><img src="DERs.tiff" width="300" height = "800"/>
</div>
...
<div align="center">
<img src="NESbar.tiff" width="400" height = "300"/>
</div>

**For identified LR-interactions, plot the average expression of the ligands in sender cells in each condition, average expression of the receptors in specified receiver cells in each condition, and the corresponding ligand scores calculated by LigScape signatures**
``` r
col = rev(colorRampPalette(brewer.pal(3, "RdBu"))(1000))
...
<div align="center">
<img src="LRI_Lavg.tiff" width="300" height = "300"/><img src="LRI_Lscore.tiff" width="120" height = "300"/><img src="LRI_Ravg.tiff" width="150" height = "300"/>
</div>
...
<div align="center">
<img src="circos.tiff" width="400" height = "400"/>
</div>
